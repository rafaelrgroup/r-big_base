...
def bind_fields(record, body, definitions, connection):
    ...
    for item in body['items']:
        ...
        metadata.update(custom_field=deepcopy(contract), field_definition=saved,
                        ...
                        catalog_environment=('postgresql_'+getattr(getattr(connection,'bigbase_deployment_identity',None),'environment','synthetic')) if is_pg else 'local_synthetic', canonical_search_state='pending',
